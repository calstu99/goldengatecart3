  ...
  return (
    <section className="mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl lg:px-8">
      ...
      <div className="bg-cover bg-center h-screen"
        style={{ backgroundImage: "url('https://images.pexels.com/photos/3825880/pexels-photo-3825880.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=200&w=200')" }}>


        <div className="mx-4 mb-8 flex flex-wrap justify-between md:mb-16">
        ...
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          <div className="flex mx-2 h-12 w-84 divide-x overflow-hidden rounded-lg border border-violet-300">
            {Hero_links.map((link, idx) => (
              <Link
                key={idx}
                href={link.href}
                className="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200 px-4 py-2"
              >
          ...
          <div className="flex flex-col items-center space-y-2">
            ...
            {/* <button className="bg-pink-500 text-white font-bold py-2 px-4 rounded hover:bg-pink-600 active:bg-pink-700 transition duration-150">
              Buy Now
            </button> */}
           

            <Link href={Hero_offers[0].href} passHref>
              <button className="bg-pink-500 text-white font-bold py-3 px-6 text-lg rounded hover:bg-pink-600 active:bg-pink-700 transition duration-150">
                Buy Now
              </button>
            </Link>

            <div className="flex mx-2 h-12 w-64 bg-hero-text-400 divide-x overflow-hidden rounded-lg border border-violet-300">
