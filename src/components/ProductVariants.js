          ...
          {selectedProduct.variants.edges.length === 1 ? (
            <>
              <div className="flex flex-col md:flex-row">
                ...
                <div className='text-2xl text-slate-700 hover:text-blue-600 font-extrabold mb-4'>{selectedProduct.title}</div>
                  <ImageGallery images={selectedProduct.images.edges} />
                </div>
                <div className="flex-1 px-6">
                  ...
                  <span className="text-grey-500 text-sm ml-4">
                    {selectedProduct.totalInventory < 6 ? (
                      <span className="text-red-500">Almost sold out</span>
                    ) : (
                      <span>{selectedProduct.totalInventory} items left</span>
                    )}
                  </span>
